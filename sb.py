...
#client = LineClient()
client = LineClient(id='email', passwd='pw email')
#client = LineClient(authToken='Auth Thoken')
                            ...
                            if text.lower() == 'i':
                                ...
                                try:
                                    ...
                                    for i in range(len(st)):
                                        ...
                                        channel.comment(str(sender), str(result), 'Auto Like Penyihirs')
                                    client.sendText(receiver, 'Done 😎😎Corat Coret😎😎 '+str(len(st))+' Post From' + str(s))
                                ...
                                client.sendText(receiver, "Umatnya ada: "+str(jml))
                            elif text.lower() == 'cekrek':
                                try:
                    ...
                    if cctv['cyduk'][op.param1]==True:
                        if op.param1 in cctv['point']:
                            ...
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                pref=['mau cctipi ya😎😎 ☛','hayooo kecydukk😂😂','hallo🙌🙌 ','Jgn nyimak z 😏😏','cctipi mulu😪😪','ketauan 🕵🕵']
